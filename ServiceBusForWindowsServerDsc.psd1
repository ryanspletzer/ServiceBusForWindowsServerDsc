...
Description = 'This DSC module is used to deploy and configure a Service Bus for Windows Server farm.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @( 'DesiredStateConfiguration', 'DSC', 'DSCResource', 'ServiceBusForWindowsServer' )

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/ryanspletzer/ServiceBusForWindowsServerDsc/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/ryanspletzer/ServiceBusForWindowsServerDsc'
