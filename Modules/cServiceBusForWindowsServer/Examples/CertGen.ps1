...
.\makecert.exe -n "CN=Development Document Encryption" -pe -ss My -sr LocalMachine -sky exchange -m 120 -in "Development Root" -is Root -ir LocalMachine -a sha256 -eku